import{_ as s,o as n,c as a,U as e}from"./chunks/framework.9a5729ca.js";const D=JSON.parse('{"title":"升级指南：粒子 从 v3.5.x 升级到 v3.6.0","description":"","frontmatter":{},"headers":[],"relativePath":"zh/manual/particle-system/particle-upgrade-documentation-for-v3.5-to-v3.6.md","filePath":"zh/manual/particle-system/particle-upgrade-documentation-for-v3.5-to-v3.6.md"}'),l={name:"zh/manual/particle-system/particle-upgrade-documentation-for-v3.5-to-v3.6.md"},p=e(`<h1 id="升级指南-粒子-从-v3-5-x-升级到-v3-6-0" tabindex="-1">升级指南：粒子 从 v3.5.x 升级到 v3.6.0 <a class="header-anchor" href="#升级指南-粒子-从-v3-5-x-升级到-v3-6-0" aria-label="Permalink to &quot;升级指南：粒子 从 v3.5.x 升级到 v3.6.0&quot;">​</a></h1><h2 id="cpu-粒子" tabindex="-1">CPU 粒子 <a class="header-anchor" href="#cpu-粒子" aria-label="Permalink to &quot;CPU 粒子&quot;">​</a></h2><p>v3.6.0 粒子系统新增了 instance 支持，粒子 shader particle-vs-legacy.chunk 需要做如下修改：</p><p>原来的 layout：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">in vec3 a_position; // center position</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  in vec3 a_normal;     // mesh normal</span></span>
<span class="line"><span style="color:#A6ACCD;">  in vec4 a_color1;     // mesh color</span></span>
<span class="line"><span style="color:#A6ACCD;">#endif</span></span></code></pre></div><p>其它 shader 代码需要参考 v3.6.0 的 particle-vs-gpu.chunk 进行修改。</p>`,15),o=[p];function c(i,t,r,C,A,_){return n(),a("div",null,o)}const v=s(l,[["render",c]]);export{D as __pageData,v as default};
