import{_ as s,o as n,c as a,U as l}from"./chunks/framework.9a5729ca.js";const A=JSON.parse('{"title":"推荐编码规范","description":"","frontmatter":{},"headers":[],"relativePath":"zh/manual/scripting/reference/coding-standards.md","filePath":"zh/manual/scripting/reference/coding-standards.md"}'),p={name:"zh/manual/scripting/reference/coding-standards.md"},o=l(`<h1 id="推荐编码规范" tabindex="-1">推荐编码规范 <a class="header-anchor" href="#推荐编码规范" aria-label="Permalink to &quot;推荐编码规范&quot;">​</a></h1><p>下面是 Cocos Creator 开发团队使用的编码规范，收录在手册里以供游戏开发者和工具开发者参考。</p><h2 id="命名规范" tabindex="-1">命名规范 <a class="header-anchor" href="#命名规范" aria-label="Permalink to &quot;命名规范&quot;">​</a></h2><ul><li><p>当我们为变量，函数和实例命名时, 使用 camelCase 命名法。</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// bad</span></span>
